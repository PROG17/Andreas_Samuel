...
exports.makeBooking = (req, res) => {
    ...
    bookingManager.GetUnavailableDates((unavailableDates) => {

        customValidation.validateDates(req.body.dates, unavailableDates, errorStrings);
        ...
        customValidation.validateDateFormat(req.body.bookingDate, errorStrings);
        ...
        res.status(500).send("Oväntat fel, kan ej hämta upptagna datum från databasen.");
        return;
    });
